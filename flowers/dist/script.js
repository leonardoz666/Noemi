...
// Garantir tela transparente desde o primeiro frame
...
// Expor função global para controlar cliques a partir do parent (iframe)
// Útil para integrar como fundo sem capturar eventos diretamente
window.__flowersSetPointer = (x, y) => {
    try {
        pointer.x = x;
        pointer.y = y;
        pointer.clicked = true;
